  ...
  return (
    ...
    >
      ...
      <div className="cdn-container relative z-10 flex flex-col items-center text-center gap-7 py-24">
        ...
        {/* Heading */}
        <h1 className="font-black m-0" style={{ fontSize: 'clamp(2.4rem, 5vw, 3.8rem)', lineHeight: 1.1, letterSpacing: '-1px' }}>
        ...
        {/* Subtext */}
        <p className="m-0" style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.68)', lineHeight: 1.85, maxWidth: 540 }}>
        ...
        <div className="mt-10">
          <div style={{
            ...
            justifyContent: 'center', paddingTop: 6, margin: '0 auto',
          }}>
            <div style={{
              width: 4, height: 8,
