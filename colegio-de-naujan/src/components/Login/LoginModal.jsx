...
import { validateLogin, recordLoginSession } from '../../lib/auth';
...
const LoginModal = ({ onLogin, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { ok, user, error: authError } = await validateLogin(username, password);
      ...
      <div className="lm-panel" role="dialog" aria-modal="true" aria-label="Sign in to portal">
        ...
        <div className="lm-header">
          ...
          <div className="lm-title-group">
            ...
            <p className="lm-hint">
              Staff: use your username. Students: use your <strong>student number</strong> + <strong>last name</strong> as password.
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="lm-form" noValidate>
          <div className="lm-field">
            <label htmlFor="lm-username" className="lm-label">Username / Student Number</label>
            <div className="lm-input-wrap">
              ...
              <input
                ...
                type="text"
                className="lm-input"
                placeholder="e.g. admin or 2026-0001"
                value={username}
          ...
          <div className="lm-field">
            <label htmlFor="lm-password" className="lm-label">Password / Last Name</label>
            <div className="lm-input-wrap">
              <svg className="lm-input-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <input
                ...
                className="lm-input"
                placeholder="Password or LASTNAME"
                value={password}
          ...
          {/* Student login hint */}
          <div style={{ background: '#eef1fb', borderRadius: 10, padding: '0.6rem 0.85rem', display: 'flex', gap: '0.5rem', alignItems: 'flex-start' }}>
            <svg style={{ width: 15, height: 15, color: '#002280', flexShrink: 0, marginTop: 1 }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
            </svg>
            <p style={{ fontSize: '0.72rem', color: '#002280', margin: 0, fontWeight: 600, lineHeight: 1.5 }}>
              Students: enter your <strong>student number</strong> as username and your <strong>LAST NAME</strong> (all caps) as password.
            </p>
          </div>
        ...
        <p className="lm-footer-note">
          For account access issues, contact the CDN website administrator.
        </p>
      </div>
    </div>
  );
